...
# junta los comentarios en una concatenacion
...
def main():
    ...
    while ruta_archivo_actual:
        ...
        if numeros_texto is not None:
            ...
            todo_contenido += contenido  # Concatena el contenido del archivo
    ...
    # Imprimir el contenido de todos los archivos con saltos de línea
    print("\nContenido de todos los archivos:")
    print(todo_contenido)  # Se imprimirá con saltos de línea ya que el contenido ya contiene saltos de línea
