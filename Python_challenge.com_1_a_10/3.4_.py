...
def encontrar_letras_minusc_entre_mayusc(cadena):
    ...
    patron = r"[^A-Z]+[A-Z]{3}([a-z])[A-Z]{3}[^A-Z]+"
...
# Utilizar la función encontrar_letras_minusc_entre_mayusc para encontrar las letras minúsculas en el contenido HTML
letras_y_mayusc = encontrar_letras_minusc_entre_mayusc(html_content)

# Construir la URL utilizando las letras minúsculas encontradas
characters = [letra[0] for letra in letras_y_mayusc]
